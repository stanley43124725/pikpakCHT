<template>
  <div class="list-page">
    <n-row>
      <n-col :span="12">
        <n-statistic label="會員分成(天/次)" :value="invitationInfo?.invited_join_days ">
          <template #prefix>
            <n-icon>
              <diamond />
            </n-icon>
      ...
      <n-col :span="12">
        <n-statistic label="邀請獎勵(天/人)" :value="invitationInfo?.add_days">
          <template #prefix>
            <n-icon>
              <accessible />
            </n-icon>
        ...
        <n-statistic label="邀請連結" >
          ...
          <template #default>
            <n-space inline>
              ...
              <n-button size="small" type="primary" @click="copy('https://toapp.mypikpak.com/activity/invited?code=' + invitationCode)">複製</n-button>
            </n-space>
            <n-input-group >
            </n-input-group>
          </template>
      ...
      <n-col :span="12">
        <n-statistic label="下載推廣" >
          ...
          <template #default>
            <n-button size="small" type="primary" @click="getChaApkDownloadLink">立即下載</n-button>
          </template>
        </n-statistic>
      </n-col>
    </n-row>
